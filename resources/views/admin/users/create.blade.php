                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Kelas Aktif Awal (Opsional untuk Siswa) -->
                            <div>
                                <x-input-label for="current_course_id" :value="__('Kelas Aktif Awal (Opsional)')" />
                             ...
                             <!-- Guru Pembimbing (Opsional untuk Siswa) -->
                            <div>
                                <x-input-label for="teacher_id" :value="__('Guru Pembimbing (Opsional)')" />
                                <select name="teacher_id" id="teacher_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <option value="">-- Tidak ada guru pembimbing --</option>
